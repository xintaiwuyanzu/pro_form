 ...
 * @author dr
 */
public class FormDisplayFieldAddCommand extends AbstractFormDisplayCommand implements Command<FieldDisplay> {
    ...
    public FieldDisplay execute(CommandContext context) {
        validateFieldDisplay(context, fieldDisplay, false);
     ...
     * @param insert
     */
    protected void validateFieldDisplay(CommandContext context, FieldDisplay fieldDisplay, boolean insert) {
