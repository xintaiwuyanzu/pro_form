...
public class SubFormFieldInfo implements TableInfo {
    public static final String TABLE = "SubFormField";
    ...
    public static final Column SUBFORMID = new Column(TABLE, "subFormId", "subFormId", JdbcType.VARCHAR);
